...
def bow(sentence, words, show_details=False):
    ...
    bag = [0] * len(words)  # This should match the number of unique words
    ...
    return np.array(bag)[:100]  # Ensure output size is 100
...
def recognise():
    ...
    while True:
        ...
        for encoding in encodings:
            ...
            if matches[best_match_index] and probability > 0.7:
                ...
                print("Unknown Detected with threshold")
